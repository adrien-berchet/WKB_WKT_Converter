...
OPERATION_GROUPS = [
    ...
    ("Generic `to_*` converters", None, None),
    ("  `to_wkb(wkt)`",                   "to_wkb_from_wkt",                "to_wkb_from_wkt"),
    ("  `to_wkb(hex_wkb)`",               "to_wkb_from_hex",                "to_wkb_from_hex"),
    ("  `to_wkt(wkt)` — `normalize_wkt=False` (fast path, no WKB round-trip)",
                                           "to_wkt_from_wkt_no_normalize",   "to_wkt_from_wkt"),
    ("  `to_wkt(wkt)` — `normalize_wkt=True` (full WKT→WKB→WKT round-trip)",
                                           "to_wkt_from_wkt_normalize",      "to_wkt_from_wkt"),
    ("  `to_wkt(hex_wkb)`",               "to_wkt_from_hex",                "to_wkt_from_hex"),
    ("  `to_hex_wkb(wkt)`",               "to_hex_wkb_from_wkt",            "to_hex_wkb_from_wkt"),
    ("  `to_hex_wkb(hex_wkb)`",           "to_hex_wkb_from_hex",            "to_hex_wkb_from_hex"),
]
